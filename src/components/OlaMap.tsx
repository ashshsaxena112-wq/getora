...
export interface MapMarkerItem { id: string; latitude: number; longitude: number; title?: string; subtitle?: string; type?: 'customer' | 'store' | 'rider' | 'hub'; isDraggable?: boolean; onDragEnd?: (coords: { latitude: number; longitude: number }) => void; onClick?: () => void; }
export interface MapZonePolygon { id: string; name?: string; coordinates: [number, number][]; color?: string; }
