    ...
    <div className="space-y-4 font-['Inter',sans-serif] text-white animate-fadeIn">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-[#A7A7A7] mt-1">
            Gross volume, 12% GETORA platform commission, merchant payouts, and instant refunds.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div className="p-4 rounded-2xl bg-[#181818] border border-[#292929]">
          ...
          <p className="text-2xl font-black text-[#F59E0B] font-['Outfit',sans-serif] mt-1">₹37,132</p>
          <span className="text-[10px] text-[#A7A7A7] mt-1 block">Batch: Nature's Fresh</span>
        </div>

        <div className="p-4 rounded-2xl bg-[#181818] border border-[#292929]">
          <p className="text-xs text-[#A7A7A7]">Processed UPI Refunds</p>
          <p className="text-2xl font-black text-[#3B82F6] font-['Outfit',sans-serif] mt-1">₹1,809</p>
